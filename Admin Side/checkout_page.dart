...
class _CheckOutPageState extends State<CheckOutPage> {
  ...
  Widget buildPay({String? name, bool? click}) {
    return TextButton.icon(
      icon: Icon(
        Icons.check, // Use the built-in Icons class for a checkmark
        color: click! ? kFloatingButton : Colors.white,
      ),
      label: Text(
        name!,
        style: TextStyle(
          color: click! ? kScrollTabClicked.color : kFlightDateDisplay.color,
          fontSize: click! ? kScrollTabClicked.fontSize : kFlightDateDisplay.fontSize,
          fontWeight: click! ? kScrollTabClicked.fontWeight : kFlightDateDisplay.fontWeight,
