          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _drawerTabs(icon: Icons.home, tabName: 'Home'),
                _drawerTabs(icon: Icons.person, tabName: 'Profile'),
                _drawerTabs(icon: Icons.wallet, tabName: 'Balance'),
                _drawerTabs(icon: Icons.shopping_basket, tabName: 'Tickets'),
                _drawerTabs(icon: Icons.monitor_heart, tabName: 'Favorites'),
                _drawerTabs(icon: Icons.help, tabName: 'Help'),
                _drawerTabs(icon: Icons.settings, tabName: 'Settings'),
                Container(
